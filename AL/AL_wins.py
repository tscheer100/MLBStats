...
def setup_path():
    ...
    txt = f"{dir_path}\AL_wins.txt"



def get_stats():
    with open(txt, "w") as f:
        f.write("Wins by Player Ranking in the American League")
    ...
    for x in range(0, max_num_players, players_per_page):
        time.sleep(0.05)
        url = "http://www.espn.com/mlb/stats/pitching/_/league/al/sort/wins/count/{}/qualified/false".format(x)
