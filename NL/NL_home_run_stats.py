...
def setup_path():
    ...
    txt = f'{dir_path}/NL_home_run_stats.txt'


def get_stats():
    with open(txt, "w") as f:
        f.write("Home run statistics by Player Ranking in the National League")
    ...
    for x in range(0, max_num_players, players_per_page):
        time.sleep(0.05)
        url = "http://www.espn.com/mlb/stats/batting/_/league/nl/sort/RBIs/count/{}/qualified/false".format(x)
