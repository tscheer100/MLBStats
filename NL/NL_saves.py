...
def setup_path():
    ...
    txt = f'{dir_path}/NL_saves.txt'


def get_stats():
    with open(txt, "w") as f:
        f.write("Saves by Player Ranking in the National League")
    ...
    for x in range(0, max_num_players, players_per_page):
        time.sleep(0.05)
        url = "http://www.espn.com/mlb/stats/pitching/_/league/nl/sort/saves/count/{}/qualified/false".format(x)
