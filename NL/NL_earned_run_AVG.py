...
def setup_path():
    ...
    txt = f'{dir_path}/NL_earned_run_AVG.txt'


def get_stats():
    with open(txt, "w") as f:
        f.write("Earned run average by Player Ranking in the National League")
    ...
    for x in range(0, max_num_players, players_per_page):
        time.sleep(0.05)
        url = "http://www.espn.com/mlb/stats/pitching/_/league/nl/count/{}/qualified/false/order/false".format(x)
